                    ...
                    <form action="{{ route('kemaskiniAhli', $ahli->noKPBaru) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <table style="width: 50%">
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" name="cariP" value="{{ $pejabat->cariP }}" class="form-control">
                                </td>
                            </tr>
                            <tr>
                                <th>
                        ...
                        <table style="width:50%">
                            <tr>
                                ...
                                <td colspan="2">
                                    <input type="text" name="cariPG" value="{{ $pejabat->cariPG }}" class="form-control">
                                </td>
                            </tr>
                            <tr>
                                <th>
                        ...
                        <a href="{{route('maklumatAhli')}}"><button class="btn btn-danger">Batal</button></a>
                    </form>
                </div>
            </div>
        </div>
